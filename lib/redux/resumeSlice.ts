...
export const selectProfile = (state: RootState) => (state.resume as Resume).profile;
export const selectWorkExperiences = (state: RootState) =>
  (state.resume as Resume).workExperiences;
export const selectEducations = (state: RootState) => (state.resume as Resume).educations;
export const selectProjects = (state: RootState) => (state.resume as Resume).projects;
export const selectSkills = (state: RootState) => (state.resume as Resume).skills;
export const selectCustom = (state: RootState) => (state.resume as Resume).custom;

export default resumeSlice.reducer as (state: Resume | undefined, action: any) => Resume;
